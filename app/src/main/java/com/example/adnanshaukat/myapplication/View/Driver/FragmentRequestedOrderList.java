...
public class FragmentRequestedOrderList extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_requested_order_list, container, false);

        mUser = (User)getArguments().getSerializable("user");
        populateUI();
        getRequestedOrders(mUser.getUser_id());
        return view;
    }

    private void populateUI(){
        orders_list =(RecyclerView) view.findViewById(R.id.fragment_list_of_requested_orders_recycler_view);
    }

    private void getRequestedOrders(int driver_id){
        ...
        try {
            ...
            Call<Object> call = api.get_order_wrt_driver_and_status_id(driver_id, "5");
...
//                            String driver_json = obj.get("drivers").toString();
                            ...
                            OrdersAdapter adapter = new OrdersAdapter(getContext(), order, "driver", "requested_order", mUser);

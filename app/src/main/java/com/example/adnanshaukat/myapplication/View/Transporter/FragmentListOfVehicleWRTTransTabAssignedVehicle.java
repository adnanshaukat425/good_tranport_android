...
public class FragmentListOfVehicleWRTTransTabAssignedVehicle extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_list_of_vehicle_wrt_trans_tab_assigned_vehicle, container, false);
        return view;
    }
    ...
    public void onResume() {
        ...
        Log.e(FragmentListOfVehicleWRTTransTabAssignedVehicle.this.toString(), user.getUser_id() + "");
    ...
    private List<User> getVehicles(String transporter_id) {
        ...
        try {
            ...
            Call<List<Vehicle>> call = api.get_assigned_vehicle_wrt_transporter(transporter_id);
            ...
            call.enqueue(new Callback<List<Vehicle>>() {
                ...
                public void onResponse(Call<List<Vehicle>> call, Response<List<Vehicle>> response) {
                    ...
                    if(vehicles!=null && vehicles.size() > 0) {
                        ...
                        RecyclerView recyclerView  = (RecyclerView)view.findViewById(R.id.fragment_list_of_assigned_vehicle_trans_recycler_view);

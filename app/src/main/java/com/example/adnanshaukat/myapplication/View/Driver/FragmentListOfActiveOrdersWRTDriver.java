...
/**
 * Created by AdnanShaukat on 16/05/2019.
 */

public class FragmentListOfActiveOrdersWRTDriver extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_list_of_order_wrt_driver_tab_active_drivers, container, false);

        Bundle arguments = getArguments();
        mUser = (User)arguments.getSerializable("user");
        populateUI();

        getAllOrders(mUser.getUser_id(), "3");//3 -> In Progress
        return view;
    }

    private void populateUI() {
        recyclerView = (RecyclerView) view.findViewById(R.id.fragment_list_of_active_order_wrt_driver_recycler_view);
    }
        ...
        try {
            ...
            call.enqueue(new Callback<Object>() {
                ...
                public void onResponse(Call<Object> call, Response<Object> response) {
                    Log.e("ActiveOrderResponse", response.toString());
...
//                          String driver_json = obj.get("drivers").toString();
                            ...
                            OrdersAdapter adapter = new OrdersAdapter(getContext(), order, "driver", "active_order", mUser);
                            ...
                            Log.e("OrderLstForActive", ex.toString() + ex.getStackTrace());
                        }
                    } else
                    {
                        Toast.makeText(getContext(), "No Orders found", Toast.LENGTH_SHORT).show();
